          ...
          // eslint-disable-next-line react/no-array-index-key
            <li key={`${index}-${label}`} className="block" aria-label={`Show/hide ${ariaLabel} ${label} data`}>
              ...
              >
                ...
                />
                <span className="relative block w-5 h-5 outline outline-2 outline-black rounded-[1px] border-[4px] peer-focus-visible:ring ring-[#fd0] ring-offset-2" style={{ borderColor: legendColors[index] } as CSSProperties}>
