...
type SatelliteConjunctionEventsFiltersProps = {
  params: ConjunctionsPageSearchParams;
  showFilterRadios: boolean;
};

const SatelliteConjunctionEventsFilters = ({ params, showFilterRadios }: SatelliteConjunctionEventsFiltersProps) => {
...
export { SatelliteConjunctionEventsFilters };
