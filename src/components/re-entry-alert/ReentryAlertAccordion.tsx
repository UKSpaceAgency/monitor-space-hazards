    ...
    <Accordion
      ...
      initialItems={[
          ...
          : []),
        {
          ...
          content: <ReentryAlertGuidanceOnResponse risk={lastReport?.monteCarloRisk} immediateResponse={searchParams?.immediate_response ?? event.immediateResponse} dataPdf={t('guidance_on_response')} />,
        },
        {
