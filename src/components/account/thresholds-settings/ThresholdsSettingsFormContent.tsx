      ...
      <Table>
        ...
        <TableBody>
          <TableRow>
            ...
            <TableCell><Input id="poc_field" {...register('PROBABILITY_OF_COLLISION', { valueAsNumber: true })} className="mb-0" type="number" suffix="%" step={0.0000001} error={errors.PROBABILITY_OF_COLLISION?.message} aria-label={t('PROBABILITY_OF_COLLISION')} /></TableCell>
          </TableRow>
          <TableRow>
            ...
            <TableCell><Input id="total_miss_distance" {...register('TOTAL_MISS_DISTANCE', { valueAsNumber: true })} className="mb-0" type="number" suffix="m" error={errors.TOTAL_MISS_DISTANCE?.message} aria-label={t('TOTAL_MISS_DISTANCE')} /></TableCell>
          </TableRow>
          <TableRow>
            ...
            <TableCell><Input id="total_radial_distance" {...register('MEAN_RADIAL_MISS_DISTANCE', { valueAsNumber: true })} className="mb-0" type="number" suffix="m" error={errors.MEAN_RADIAL_MISS_DISTANCE?.message} aria-label={t('MEAN_RADIAL_MISS_DISTANCE')} /></TableCell>
          </TableRow>
          <TableRow>
            ...
            <TableCell><Input id="time_to_conjunction" {...register('TIME_TO_EVENT', { valueAsNumber: true })} className="mb-0" type="number" suffix="hours" error={errors.TIME_TO_EVENT?.message} aria-label={t('TIME_TO_EVENT')} /></TableCell>
          </TableRow>
        </TableBody>
      </Table>
      <ButtonGroup>
