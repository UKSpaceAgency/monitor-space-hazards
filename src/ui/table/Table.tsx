...
export const TableCaption = ({ className, ...props }: HTMLProps<HTMLTableCaptionElement>) => <caption className={clsx('govuk-table__caption govuk-table__caption--s mb-4', className)} {...props} />;
