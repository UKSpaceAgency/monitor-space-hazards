...
export const Regions: {
  ...
  [RegionsEnum.SHANWICK_OCEANIC_FIR]: {
    ...
    name: 'Shanwick Oceanic FIR',
  },
  [RegionsEnum.UK_AIRSPACE]: {
    id: RegionsEnum.UK_AIRSPACE,
    name: 'UK Airspace',
  },
...
export const jsonRegionsMap: Record<string, string> = {
  ...
  yorkshire_and_north_humber: 'Yorkshire and the Humber',
  yorkshire_and_the_humber: 'Yorkshire and the Humber',
  antrim_and_newtownabbey: 'Antrim and Newtownabbey',
  antrim_and_newtownabby: 'Antrim and Newtownabbey',
